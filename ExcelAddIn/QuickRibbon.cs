...
namespace ExcelAddIn
{
    ...
    public class QuickRibbon : Office.IRibbonExtensibility 
    {
        ...
        {
            return GetResourceText("ExcelAddIn.QuickRibbon.xml");
        }
        ...
        //Ribbon界面的回调函数，返回图像
        public Bitmap GetButtonImage(Office.IRibbonControl ctrl)
        {
            Bitmap myBitmap;
            switch (ctrl.Id)
            {
                case "btnCommit":
                    myBitmap = QuickRes.button1; break;
                case "btnCompile":
                    myBitmap = QuickRes.button2; break;
                default:
                    myBitmap = QuickRes.button_common; break;
            }
            return myBitmap;
        }

        //Ribbon界面的回调函数，响应事件
        public void ClickCommit(Office.IRibbonControl ctrl)
        {
            MessageBox.Show("TODO SVN Commit");
        }

        public void ClickCompile(Office.IRibbonControl ctrl)
        {
